...
function addMarker(place)
{
	...
	var contentString = "<h3>News for " + place.place_name + "</h3><ul>";	
	...
	.done(function(data, textStatus, jqXHR) 
	{
	    ...
	    if (data.length === 0)
	    {
		showInfo(marker, "No News for" + place.place_name + ".");
	    }
...
function configure()
{
    ...
    },
    {
        ...
        templates: {
            ...
            suggestion: _.template("<p><%- place_name %>, <%- admin_name1 %> <span class='light'><%- postal_code %></p>")
        }
    });
